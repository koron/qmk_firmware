...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LBRC  , KC_RBRC  , KC_LGUI  , KC_LALT  , KC_BTN2  , KC_BTN1  , MO(1)    ,            MO(2)    , KC_SPC   , _______  , _______  , _______  , KC_BSLS  , KC_GRV
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , KC_BTN4  , KC_BTN3  , KC_BTN5  , _______  , AML_I50  ,
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , KC_BTN1  , SCRL_MO  , KC_BTN2  , _______  , AML_D50  ,
